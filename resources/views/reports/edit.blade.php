...
<form action="{{ route('reports.update', $report->id) }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="merch_expenses" name="merch_expenses" required value="{{ old('merch_expenses', $report->merch_expenses) }}" placeholder="Enter Merchandise Expenses amount">
    </div>

    <div class="form-group">
        <label for="custom_expenses">Custom Expenses</label>
        <input type="number" step="0.01" class="form-control" id="custom_expenses" name="custom_expenses" required value="{{ old('custom_expenses', $report->custom_expenses) }}" placeholder="Enter Custom Expenses amount">
    </div>
